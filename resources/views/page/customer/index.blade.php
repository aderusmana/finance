                            ...
                            <div class="card mb-3 border-primary">
                                ...
                                <div class="card-body">
                                    <div class="row g-3 mb-4">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label">Email (General) <span class="text-danger">*</span></label>
                                ...
                                <div class="card-body">
                                    <div class="row g-3 mb-4">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label">Shipping To (Name) <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="shipping_to_name"
                                                id="shipping_to_name" placeholder="Recipient Name" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Shipping To (Address) <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label">Purchasing Mgr Name <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="purchasing_manager_name"
                                                id="purchasing_manager_name" placeholder="Full Name" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">Purchasing Mgr Email <span class="text-danger">*</span></label>
                                            <input type="email" class="form-control"
                                                name="purchasing_manager_email" id="purchasing_manager_email"
                                                placeholder="email@example.com" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">Purchasing Mgr Phone <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label">Finance Mgr Name <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="finance_manager_name"
                                                id="finance_manager_name" placeholder="Full Name" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">Finance Mgr Email <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label">Finance Mgr Phone <span class="text-danger">*</span></label>
                            ...
                            <div class="tab-content p-4 w-100" id="v-pills-tabContent"
                                ...
                                <div class="tab-pane fade show active" id="tab-recall-general" role="tabpanel">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label small fw-bold text-dark">No PKD (Readonly) <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control bg-light" name="no_pkd"
                                                id="recall_no_pkd" readonly required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label small fw-bold text-dark">PIC (Penanggung Jawab) <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label small fw-bold text-dark">Area <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="area"
                                                id="recall_area" required>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label small fw-bold text-dark">Postal Code <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="postal_code"
                                ...
                                <div class="tab-pane fade" id="tab-recall-finance" role="tabpanel">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label small fw-bold text-dark">CCAR <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold small text-dark text-uppercase">Billing Contact Name <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control"
                                                name="penagihan_nama_kontak" id="recall_penagihan_nama_kontak" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label fw-bold small text-dark text-uppercase">Billing Phone <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="penagihan_telepon"
                                                id="recall_penagihan_telepon" required>
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label fw-bold small text-dark text-uppercase">Billing Address <span class="text-danger">*</span></label>
                                            <textarea class="form-control" name="penagihan_address" id="recall_penagihan_address" rows="2" required></textarea>
                                        </div>
                                        <div class="col-12">
                                            <label
                                                class="form-label fw-bold small text-dark text-uppercase">Billing Email <span class="text-danger">*</span></label>
                                            <input type="email" class="form-control" name="surat_menyurat_address" id="recall_surat_menyurat_address" placeholder="email@example.com" inputmode="email" maxlength="191" required>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <label class="form-label fw-bold small text-dark text-uppercase">NPWP Number <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="npwp"
                                                id="recall_npwp" placeholder="00.000.000.0-000.000" required>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label fw-bold small text-dark text-uppercase">NPWP Date <span class="text-danger">*</span></label>
                                            <input type="date" class="form-control" name="tanggal_npwp"
                                ...
                                <div class="tab-pane fade" id="tab-recall-mgmt" role="tabpanel">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <label class="form-label small fw-bold text-dark">Purchasing Manager Name <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control"
                                                name="purchasing_manager_name" id="recall_purchasing_manager_name" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label small fw-bold text-dark">Purchasing Manager Email <span class="text-danger">*</span></label>
                                            <input type="email" class="form-control"
                                                name="purchasing_manager_email"
                                                id="recall_purchasing_manager_email" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label small fw-bold text-dark">Purchasing Manager Telpon <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control"
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label small fw-bold text-dark">Finance Manager Name <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="finance_manager_name"
                                                id="recall_finance_manager_name" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label small fw-bold text-dark">Finance Manager Email <span class="text-danger">*</span></label>
                                            <input type="email" class="form-control"
                                                name="finance_manager_email" id="recall_finance_manager_email" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label small fw-bold text-dark">Finance Manager Telpon <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control"
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label small fw-bold text-dark">Shipping Recipient Name <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" name="shipping_to_name"
                                                id="recall_shipping_to_name" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label small fw-bold text-dark">Shipping Address <span class="text-danger">*</span></label>
                                            <textarea class="form-control" name="shipping_to_address" id="recall_shipping_to_address" rows="2" required></textarea>
                                        </div>
                                    </div>
                                </div>
            ...
            $(document).ready(function() {
                ...
                $('input[type="email"]').on('input change', function() {
                    ...
                    if (errorSpan.length === 0) {
                        $(this).after('<small class="text-danger email-error d-block fw-bold mt-1" style="display:none;"></small>');
