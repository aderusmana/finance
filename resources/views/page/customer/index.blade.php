                            ...
                            <div class="card mb-3 border-primary">
                                    ...
                                    <div class="row g-3 mb-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="postal_code"
                                                id="postal_code" placeholder="e.g. 12345">
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="country" id="country"
                                                value="Indonesia" placeholder="Country">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">No PKD</label>
                                    ...
                                    <div class="row g-3 mb-4">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="shipping_to_name"
                                                id="shipping_to_name" placeholder="Recipient Name">
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="purchasing_manager_name"
                                                id="purchasing_manager_name" placeholder="Full Name">
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label">Purchasing Mgr Phone</label>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" name="finance_manager_name"
                                                id="finance_manager_name" placeholder="Full Name">
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">Finance Mgr Email</label>
                                            <input type="email" class="form-control" name="finance_manager_email"
                                                id="finance_manager_email" placeholder="email@example.com">
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">Finance Mgr Phone</label>
                                ...
                                <div class="card-body">
                                    <div class="row g-3 mb-4">
                                        ...
                                        <div class="col-md-4">
                                            <label class="form-label">Billing Contact Person</label>
                                            <input type="text" class="form-control" name="penagihan_nama_kontak"
                                                id="penagihan_nama_kontak" placeholder="Contact Person Name">
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-select select2-recall" name="ccar"
                                                id="recall_ccar" style="width:100%">
                                                <option value="smd_idr">SMD (IDR)</option>
                                                <option value="smd_usd">SMD USD</option>
                                            </select>
                                        </div>
