                                ...
                                <div style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 1.25rem; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.02); height: 100%;">
                                    <table class="table mb-0 align-middle">
                                        <thead style="background: #f8fafc;">
                                            <tr>
                                                <th style="padding: 1rem 1.5rem; color: #64748b; font-size: 0.75rem; font-weight: 700; text-transform: uppercase; border-bottom: 1px solid #e2e8f0;">Position</th>
                                                <th style="padding: 1rem 1.5rem; color: #64748b; font-size: 0.75rem; font-weight: 700; text-transform: uppercase; border-bottom: 1px solid #e2e8f0;">Full name</th>
                                                <th style="padding: 1rem 1.5rem; color: #64748b; font-size: 0.75rem; font-weight: 700; text-transform: uppercase; border-bottom: 1px solid #e2e8f0;">Email address</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td style="padding: 1rem 1.5rem; color: #475569; font-weight: 700; font-size: 0.85rem; border-bottom: 1px solid #f1f5f9;">Purchasing Mgr</td>
                                                <td class="fw-bolder" style="padding: 1rem 1.5rem; color: #0f172a; font-size: 0.9rem; border-bottom: 1px solid #f1f5f9;" id="view_purchasing_manager_name">-</td>
                                                <td style="padding: 1rem 1.5rem; color: #3b82f6; font-weight: 600; font-size: 0.9rem; border-bottom: 1px solid #f1f5f9;" id="view_purchasing_manager_email">-</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 1rem 1.5rem; color: #475569; font-weight: 700; font-size: 0.85rem; border-bottom: none;">Finance Mgr</td>
                                                <td class="fw-bolder" style="padding: 1rem 1.5rem; color: #0f172a; font-size: 0.9rem; border-bottom: none;" id="view_finance_manager_name">-</td>
                                                <td style="padding: 1rem 1.5rem; color: #3b82f6; font-weight: 600; font-size: 0.9rem; border-bottom: none;" id="view_finance_manager_email">-</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
