                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <table width="100%" style="border-collapse: collapse; background-color: #f8fafc; border-radius: 12px; overflow: hidden; border: 1px solid #e2e8f0; margin-top: 20px;">
                                ...
                                <tr>
                                    <td style="padding: 16px; font-size: 13px; color: #64748b; font-weight: 600;">Harga {{ $type === 'completed' ? 'Final' : 'Diajukan' }}</td>
                                    <td style="padding: 16px; font-size: 18px; font-weight: 700; color: {{ $type === 'completed' ? '#059669' : '#ea580c' }}; text-align: right;">
                                        Rp {{ number_format($type === 'completed' ? $extraData['newFee'] : $logisticData->proposed_fee, 0, ',', '.') }}
                                    </td>
                                </tr>
                            </table>
